...
module.exports = function(options) {
  ...
  var _updatedTokenHeader = options.updatedTokenHeader || 'Authorization-Renewed';
  ...
  var middleware = function(req, res, next) {
    ...
    async.waterfall([
      ...
      if(options.slidingExpiration && options.expiresIn) {
        res.setHeader(_updatedTokenHeader, jwt.sign(result, options.secret, {
